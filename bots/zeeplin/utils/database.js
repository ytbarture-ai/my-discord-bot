...
const db = new DatabaseSync(path.join(dataDir, 'zeeplin.db'));
...
module.exports = { db, addWarning, getWarnings, clearWarnings, removeWarning, getAutomodConfig, setAutomodConfig };
